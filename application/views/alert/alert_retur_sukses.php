        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="alert alert-success">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url().'index.php/retur'?>"><span class="fa fa-backward"></span>Kembali</a>
                   <a class="btn btn-info" href="<?php echo base_url().'index.php/retur/cetak_struck'?>" target="_blank"><span class="fa fa-print"></span>Cetak</a>
                </div>
