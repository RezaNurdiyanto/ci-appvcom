 		...
 		<div class="row">
 			<div class="col-12">
 				<div class="card">	
						...
						<!--<form action="<?php echo base_url().'index.php/sales/add_cart' ?> " method="post"> -->
												...
												<div class="tabel-responsive">
										                ...
										                <tbody style="background-color: white; color: black;">
										                	...
										                	<tr>
										                		...
										                		<td width="2%"><a name="kode_brg" href="<?php echo base_url().'index.php/sales/updateqtymin/' .$items['rowid']; ?>" class="btn btn-primary"><i class="fa fa-minus"></i></a></td>
										                		<td style="text-align: center;">					                			
										                			<?php echo number_format($items['qty']); ?>									      
										                			</td>
										                		<td width="2%">	<a name="kode_brg" href="<?php echo base_url().'index.php/sales/updateqtyplus/' .$items['rowid']; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a></td>
										                		<td style="text-align: right;"><?php echo number_format($items['subtotal']); ?></td>
										                		<td class="text-center no-padding"><a href="<?php echo base_url(). 'index.php/sales/remove/' .$items['rowid']; ?>"class="btn btn-danger btn-block btn-flat"> <i class="fa fa-trash"></i></a></td>
										                	</tr>
										                	<?php $i ++; ?>
										                <?php endforeach; ?>
										                </tbody>
						...
						<form action="<?php echo base_url().'index.php/sales/simpan_penjualan' ?>" method="post">
								<div class="row">
  ...
  $(function () {
        ...
        $(document).ready(function(){
            ...
            $("#kode_brg").on("input",function(){
                var kobar = {kode_brg:$(this).val()};
                   $.ajax({
               type: "POST",
               url : "<?php echo base_url().'index.php/sales/get_barang';?>",
               data: kobar,
    ...
    <script>
    	function editQty(qty, aksi, kode_brg) {
    		var posting = $.post('<?= base_url() ?>index.php/sales/updateqty', {
    			kode_brg : kode_brg,
    			aksi : aksi,
    			qty : qty
    		});
